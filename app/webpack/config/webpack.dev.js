...
Object.keys(baseConfig.entry).forEach(v => {
    ...
    if(v !== 'vendor') {
        baseConfig.entry[v] = [
            ...
            baseConfig.entry[v],
            // hmr 更新入口，官方指定的hmr路径
            `webpack-hot-middleware/client?path=http://${DEV_SERVER_CONFIG.HOST}:${DEV_SERVER_CONFIG.PORT}/${DEV_SERVER_CONFIG.HMR_PATH}&time=${DEV_SERVER_CONFIG.TIMEOUT}&reload=true`,
        ]
    }
